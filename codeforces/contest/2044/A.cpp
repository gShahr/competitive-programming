...
a = n-b
=> a+b = n
=> smallest pair that works is (1, n-1) and we can iterate from 1 to n-1 by moving up the first pair and moving down the second pair.
As a result, there will be (n-1)-1+1 pairs that work = n-1.
