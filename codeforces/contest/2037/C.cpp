...
bounded at 2n-1 inclusive

<= 4 => -1
> 4 => then 4 and 5 will always be available and one adjacency between evens and odds.
evens + evens are always composite
odds + odds are always composite
