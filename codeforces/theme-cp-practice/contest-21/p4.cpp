...
Remove decreasing sequence from left to right. First instance of applying operation
should result in elemnt > 1.

If I still have operations left, need to apply them
